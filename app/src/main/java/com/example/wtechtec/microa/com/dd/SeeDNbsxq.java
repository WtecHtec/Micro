...
public class SeeDNbsxq extends AppCompatActivity {
    ...
    private DNbsIfo dlkdIfo;
    private UserIfo userIfo;
    private TextView  textViewqhh,textViewshdz,textViewshhm,textViewshsj,textViewbzly,textViewzt;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
    setContentView(R.layout.dnxq_layout);
        InitView();
    }
    ...
    private void InitView() {
        ...
        dlkdIfo=intent.getParcelableExtra("DNBS");
        ...
        imageViewcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder normalDialog = new AlertDialog.Builder(SeeDNbsxq.this);
       ...
       button.setVisibility(View.GONE);
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        new JDData().AddData(dlkdIfo.getId(), userIfo.getUserid(), userIfo.getHm(), "帮手", "否", userIfo.getNick(),xdsj);
                                        new DNbsData().GetJDMmess(dlkdIfo.getId());
                                        Intent intent1=new Intent(SeeDNbsxq.this, MyJD.class);
        ...
        textViewqhh.setText(dlkdIfo.getDnsw());
        textViewshdz.setText(dlkdIfo.getBsaddress());
        textViewshhm.setText(dlkdIfo.getBsphon());
        textViewshsj.setText(dlkdIfo.getBssj());
        textViewbzly.setText(dlkdIfo.getBsly());
