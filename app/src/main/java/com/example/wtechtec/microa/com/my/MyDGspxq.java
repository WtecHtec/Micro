...
public class MyDGspxq extends AppCompatActivity {
    ...
    private void InitView() {
        ...
        dlkdIfo=intent.getParcelableExtra("DGspIfo");
...
imageViewcall.setVisibility(View.GONE);
        ...
        imageViewcall1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder normalDialog = new AlertDialog.Builder(MyDGspxq.this);
