...
public class SeeDGspxq extends AppCompatActivity {
    ...
    setContentView(R.layout.dgxq_layout);
        InitView();
    }
    ...
    private void InitView() {
        ...
        dlkdIfo=intent.getParcelableExtra("DGSP");
        ...
        imageViewcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder normalDialog = new AlertDialog.Builder(SeeDGspxq.this);
                             ...
                             public void onClick(DialogInterface dialog, int which) {
                                 new Thread() {
                                     ...
                                     public void run() {
                                         ...
                                         new JDData().AddData(dlkdIfo.getId(), userIfo.getUserid(), userIfo.getHm(), "代购", "否", userIfo.getNick(),xdsj);
                                         new DGspData().GetJDMmess(dlkdIfo.getId());
                                   Intent intent1=new Intent(SeeDGspxq.this, MyJD.class);
        ...
        textViewqhdz.setText(dlkdIfo.getSpname());
        textViewqhh.setText(dlkdIfo.getSpnumber());
        textViewshdz.setText(dlkdIfo.getShaddress());
        textViewshhm.setText(dlkdIfo.getShphone());
