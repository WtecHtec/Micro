...
public class MyDNbsxq extends AppCompatActivity {
    private LinearLayout linearLayout;
    private Button button;
    private  String Did;
    private ImageView imageView,imageViewcall,imageViewcall1;
    private DNbsIfo dlkdIfo;
    private TextView textViewqhh,textViewshdz,textViewshhm,textViewshsj,textViewbzly,textViewzt,textViewname,textViewhm,textViewxh;
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                for(int i=0;i<jsonArray.length();i++){
                    ...
                    if(zt.equals("是")){
                        textViewzt.setText("完成订单");   button.setVisibility(View.GONE);
                    }
    ...
    private void InitView() {
        ...
        imageViewcall1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder normalDialog = new AlertDialog.Builder(MyDNbsxq.this);
