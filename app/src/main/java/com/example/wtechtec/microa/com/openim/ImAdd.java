...
public class ImAdd {
    ...
    public  String SendMsg(UserIfo userIfo) throws IOException {
        Map<String, String> params = new HashMap<String, String>();

        // 公共参数
        params.put("method", "taobao.openim.users.add");
...
params.put("userinfos","{'nick':'"+userIfo.getNick()+"','address':'"+userIfo.getXx()+"','userid':'"+userIfo.getUserid()+"','mobile':'"+userIfo.getHm()+"','password':'"+userIfo.getPassword()+"'}");
    ...
    private  void  callApi( Map<String, String> params) throws IOException {
